...
•
Tenemos que programar 2 tipos de personajes: los  
Magos
  y los
Clerigos
.
...
Escribe una clase 
Personaje
 que reúna los atributos mencionados en el
...
•
Al crearse, un Mago no puede tener en inteligencia un valor
menor que 17 ni en fuerza un valor mayor que 15.
•
Además un 
Mago
 almacena los nombres de los hechizos que ha
memorizado. Un mago  sólo puede memorizar a la vez un máximo
de   4   hechizos.   Impleméntalo   como   un   array   y   añade   los
siguientes métodos:
◦
aprendeHechizo
: que tiene un parámetro de tipo  
String
  y
...
◦
lanzaHechizo
: que tiene como parámetro un objeto de tipo
Personaje que será el personaje sobre el que recae el
hechizo y el  
String
  correspondiente a un hechizo. Las
...
Reescribe el método 
toString
 para que se muestren los nuevos
...
Al crearse, un 
Clerigo
 no puede tener una fuerza con un valor
menor que 18 y una inteligencia con un valor menor que 12 ni
mayor que 16, ambos incluidos.
•
El 
Clerigo
 reza a un dios para obtener el don de la curación. Por
lo tanto se deberá modificar el constructor genérico para aceptar
el nombre del dios, del cual el  
Clerigo
  es devoto y así poder
almacenarlo.
•
Un  
Clerigo
  tiene el don de curar, por lo tanto, la clase deberá
tener un método 
curar
, que recibe como parámetro un objeto de
tipo  Personaje  sobre el  que recae la  acción de  curar y que
aumenta en 10 los puntos de vida.
•
Reescribe el método 
toString
 para que muestre además de los
datos básicos el nombre del dios.
Apartado 4:
Escribe una clase de prueba con un método 
main
 en la que se creen 2
Magos
  (A y B) y un  
Clerigo
  (C) y en el que tengan que realizar las
siguientes acciones:
•
...
El 
Mago
 A aprende 2 hechizos.
•
El 
Mago
 B aprende 1 hechizo.
•
Imprimir los datos de los 
Magos
.
•
El 
Mago
 A lanza un hechizo sobre el 
Mago
 B.
•
El 
Mago
 B lanza un hechizo sobre el 
Mago
 A.
•
El 
...
Imprimir los datos de los tres personajes.
NOTA
:   los   casos   en   los   que   un   atributo   pueda   tomar   valores   no
permitidos   hay   que   controlarlos   lanzando   la   excepción
PersonajeException.package com.monroy.principal;
 * @author alumnodiurno
 *
 */
